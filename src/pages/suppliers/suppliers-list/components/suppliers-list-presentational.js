...
const SupplierListPresentational = ({
	filteredData,
	column,
	tableLoading,
	rowSelection,
	...
	return (
		<>
												...
												{selectedRowKeys?.length === 1 ? (
													<Col>
														<Popconfirm
															...
															cancelText="No"
															onConfirm={() => {
																let url = `${SERVER_IP}supplier/${selectedRowKeys?.[0]}?orgId=${globalRedux?.selectedOrganization?._id}`;
			...
			<AddSupplier {...{ supplierAddModal, setSupplierAddModal, refreshList, editSupplier, handleClose }} />
		</>
	);
};

export default SupplierListPresentational;
