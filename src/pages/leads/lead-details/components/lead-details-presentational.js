...
const LeadPresentational = () => {
  ...
  const leadData = {
    ...
    modifiedBy: leadsRedux?.leadData?.updated_by_name,
    modifiedDate: leadsRedux?.leadData?.updatedAt,
    company: leadsRedux?.leadData?.company_name,
    leadName: `${leadsRedux?.leadData?.first_name || ""} ${leadsRedux?.leadData?.last_name || ""}`.trim(),
    ...
    createdBy: leadsRedux?.leadData?.created_by_name,
    createdDate: leadsRedux?.leadData?.createdAt,
    linkedIn_profile: leadsRedux?.leadData?.linkedin_profile,
    secondaryEmail: leadsRedux?.leadData?.secondary_email,
    time_zone: leadsRedux?.leadData?.time_zone,
    Status: leadsRedux?.leadData?.Status,
    street: `${leadsRedux?.leadData?.address_line_one || ""} ${leadsRedux?.leadData?.address_line_two || ""}`.trim(),
    ...
    <>
      <Col className="lead_container">
        <div className="lead-details">
          <div className="lead-details__header" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <div className="lead-details__content">
              ...
              <div className="lead-details__grid">
                <div className="lead-details__column">
                  <div className="lead-field">
                    ...
                    <div className="lead-field__value">{leadData.leadOwner || "-"}</div>
                  </div>
                  <div className="lead-field">
                  ...
                  <div className="lead-field">
                    ...
                    <div className="lead-field__value lead-field__value--phone">{leadData.phone || "-"}</div>
                  </div>
                  <div className="lead-field">
                    <label className="lead-field__label">Mobile</label>
                    <div className="lead-field__value lead-field__value--phone">{leadData.mobile || "-"}</div>
                  </div>
                  <div className="lead-field">
                  ...
                  <div className="lead-field">
                    ...
                    <div className="lead-field__value lead-field__value--with-date">
                      ...
                      <div className="lead-field__date">
                        {leadData.modifiedDate ? dayjs(leadData.modifiedDate).format("DD-MM-YYYY HH:mm") : "-"}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="lead-details__column">
                  ...
                  <div className="lead-field">
                    ...
                    <div className="lead-field__value lead-field__value--email">{leadData.email || "-"}</div>
                  </div>
                  <div className="lead-field">
                    <label className="lead-field__label">Website</label>
                    <div className="lead-field__value lead-field__value--link">{leadData.website || "-"}</div>
                  </div>
                  <div className="lead-field">
                    <label className="lead-field__label">No. of Employees</label>
                    <div className="lead-field__value">{leadData.numberOfEmployees || "-"}</div>
                  </div>
                  <div className="lead-field">
                    ...
                    <div className="lead-field__value lead-field__value--with-date">
                      ...
                      <div className="lead-field__date">
                        {leadData.createdDate ? dayjs(leadData.createdDate).format("DD-MM-YYYY HH:mm") : "-"}
                      </div>
                    </div>
                  </div>
                  <div className="lead-field">
                    <label className="lead-field__label">LinkedIn Profile</label>
                    <div className="lead-field__value lead-field__value--skype">{leadData.linkedIn_profile || "-"}</div>
                  </div>
                  <div className="lead-field">
                    <label className="lead-field__label">Secondary Email</label>
                    <div className="lead-field__value">{leadData.secondaryEmail || "-"}</div>
                  </div>
                  <div className="lead-field">
                    <label className="lead-field__label">Time Zone</label>
                    <div className="lead-field__value">{leadData.time_zone || "-"}</div>
                  </div>
                  <div className="lead-field">
                    <label className="lead-field__label">Status</label>
                    <div className="lead-field__value">{leadData.Status || "-"}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lead-details__section">
              <h3 className="lead-details__section-title">Address Information</h3>
              <div className="lead-details__grid">
                <div className="lead-details__column">
                  <div className="lead-field">
            ...
            <div className="lead-details__section">
              <h3 className="lead-details__section-title">Description Information</h3>
              <div className="lead-field">
