...
const ContactDetailsPresentational = () => {
  ...
  const contactData = {
    ...
    contactName: `${contactRedux?.contactData?.first_name || ""} ${contactRedux?.contactData?.last_name || ""}`.trim(),
  ...
  return (
    <Col className="contact_container">
      <div className="contact-details">
        <div className="contact-details__header" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        ...
        <div className="contact-details__content">
          ...
          <div className="contact-details__section">
            <h3 className="contact-details__section-title">Contact Information</h3>
            <div className="contact-details__grid">
              <div className="contact-details__column">
                <div className="contact-field">
                  ...
                  <div className="contact-field__value">{displayValue(contactData.contactOwner)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Account Name</label>
                  <div className="contact-field__value">{displayValue(contactData.account_name)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Email</label>
                  <div className="contact-field__value contact-field__value--phone">{displayValue(contactData.email)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Phone</label>
                  <div className="contact-field__value contact-field__value--phone">{displayValue(contactData.phone)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Mobile</label>
                  <div className="contact-field__value">{displayValue(contactData.mobile)}</div>
                </div>
                <div className="contact-field">
                  ...
                  <div className="contact-field__value">
                    ...
                    <div className="contact-field__date">{formatDate(contactData.createdDate)}</div>
                  </div>
                </div>
                <div className="contact-field">
                  ...
                  <div className="contact-field__value">
                    ...
                    <div className="contact-field__date">{formatDate(contactData.modifiedDate)}</div>
                  </div>
                </div>
              </div>
              ...
              <div className="contact-details__column">
                <div className="contact-field">
                  ...
                  <div className="contact-field__value">{displayValue(contactData.contactName)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Title</label>
                  <div className="contact-field__value">{displayValue(contactData.title)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Department</label>
                  <div className="contact-field__value">{displayValue(contactData.department)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">LinkedIn Profile</label>
                  <div className="contact-field__value contact-field__value--skype">{displayValue(contactData.linkedIn_profile)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Secondary Email</label>
                  <div className="contact-field__value">{displayValue(contactData.secondaryEmail)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Time Zone</label>
                  <div className="contact-field__value">{displayValue(contactData.time_zone)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Status</label>
                  <div className="contact-field__value">{displayValue(contactData.Status)}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="contact-details__section">
            <h3 className="contact-details__section-title">Address Information</h3>
            <div className="contact-details__grid">
              <div className="contact-details__column">
                <div className="contact-field">
                  <label className="contact-field__label">Mailing Street</label>
                  <div className="contact-field__value">{displayValue(contactData.mailing_street)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Mailing City</label>
                  <div className="contact-field__value">{displayValue(contactData.mailing_city)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Mailing State</label>
                  <div className="contact-field__value">{displayValue(contactData.mailing_state)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Mailing Zip</label>
                  <div className="contact-field__value">{displayValue(contactData.mailing_zip_code)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Mailing Country</label>
                  <div className="contact-field__value">{displayValue(contactData.mailing_country)}</div>
                </div>
              </div>
              <div className="contact-details__column">
                <div className="contact-field">
                  <label className="contact-field__label">Other Street</label>
                  <div className="contact-field__value">{displayValue(contactData.other_street)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Other City</label>
                  <div className="contact-field__value">{displayValue(contactData.other_city)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Other State</label>
                  <div className="contact-field__value">{displayValue(contactData.other_state)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Other Zip</label>
                  <div className="contact-field__value">{displayValue(contactData.other_zip_code)}</div>
                </div>
                <div className="contact-field">
                  <label className="contact-field__label">Other Country</label>
                  <div className="contact-field__value">{displayValue(contactData.other_country)}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="contact-details__section">
            <h3 className="contact-details__section-title">Description Information</h3>
            <div className="contact-field">
              <label className="contact-field__label">Description</label>
              <div className="contact-field__value">{displayValue(contactData.description)}</div>
            </div>
          </div>
        </div>
      </div>
