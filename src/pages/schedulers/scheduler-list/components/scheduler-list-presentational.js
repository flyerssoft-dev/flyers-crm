...
import AddScheduler from 'pages/schedulers/add-scheduler';

const SchedulerListPresentational = ({
	filteredData,
	column,
	tableLoading,
	rowSelection,
	...
	return (
		<>
												...
												{selectedRowKeys?.length === 1 ? (
													<Col>
														<Popconfirm
															...
															cancelText="No"
															onConfirm={() => {
																let url = `${SERVER_IP}scheduler/${selectedRowKeys?.[0]}?orgId=${globalRedux?.selectedOrganization?._id}`;
			...
			<AddScheduler {...{ schedulerAddModal, setSchedulerAddModal, refreshList, editScheduler, handleClose }} />
		</>
	);
};

export default SchedulerListPresentational;
