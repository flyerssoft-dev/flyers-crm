...
import AddOrder from 'pages/orders/add-order';
import UpdateStatusModal from './update-status-modal';
import ItemsModal from './items-modal';

const OrdersListPresentational = ({
	column,
	filteredData,
	handleTableChange,
	getStartingValue,
	...
	return (
		<Row>
			...
			<AddOrder {...{ state, setState, refreshList, editData }} />
			<ItemsModal {...{ setSelectedViewRow, selectedViewRow }} />
		</Row>
	);
};

export default OrdersListPresentational;
