...
const AddOrderPresentational = ({
	...
	return (
		<Drawer
			maskClosable={false}
			title={`${editData ? 'Edit' : 'Create'} Order`}
			placement="right"
			width={'60%'}
			open={state?.visible}
			destroyOnHidden
						...
						{...{
										...
										<Row
											...
											<Col xl={9} md={9} style={{ textAlign: 'right', fontWeight: 'bold' }}>
												<Input
													...
													value={orderInputDetails?.shipping}
													placeholder="0.00"
												/>
											</Col>
										</Row>
										<Row>
											...
											<Col xl={9} md={9} style={{ textAlign: 'right', fontWeight: 'bold' }}>
												<Input
													...
													value={orderInputDetails?.discount}
													placeholder="0.00"
												/>
											</Col>
										</Row>
							...
							title: () => (
								<Row justify="space-between">
									<Col xl={24} md={24}>
										<Form labelAlign="left" name="add-order" style={{}} form={form} onFinish={handleSubmit} {...layer1FormCol}>
											<Row gutter={[20, 20]}>
												<Col xl={12} md={12}>
													<Form.Item
														label="Customer"
...
export default AddOrderPresentational;
