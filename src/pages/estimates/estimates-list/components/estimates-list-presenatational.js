...
import AddEstimate from 'pages/estimates/add-estimate';
import UpdateStatusModal from './update-status-modal';
import ItemsModal from './items-modal';

const EstimatesListPresentational = ({
	column,
	filteredData,
	handleTableChange,
	getStartingValue,
	...
	return (
		<Row>
			...
			<AddEstimate {...{ state, setState, refreshList, editData }} />
			<ItemsModal {...{ setSelectedViewRow, selectedViewRow }} />
		</Row>
	);
};

export default EstimatesListPresentational;
