...
import { Button, Select, Modal, Drawer, Row, Col, Form, Input, Checkbox } from 'antd';
...
const AddWHInvoicePresentational = ({
	state,
	setState,
	handleSubmit,
	columns,
	...
	return (
		...
		<Drawer
			maskClosable={false}
			title={`${editData ? 'Edit' : 'New'} WHInvoice`}
			placement="right"
			width={'80%'}
			open={state?.visible}
			destroyOnHidden
...
export default AddWHInvoicePresentational;
