...
const STATUS_DROPDOWN = ['Open', 'Assigned', 'Accepted', 'In Progress', 'Completed', 'Cancelled', 'Pending'];
const ORDER_STATUS_DROPDOWN = ['Pending', 'Ready to Dispatch', 'Completed', 'Cancelled'];
...
export { CUSTOMER_TYPE, GST_TREATMENT, PLACE_OF_SUPPLY, SCHEDULER_TYPE, USER_TYPE, CATEGORIES, STATUS_DROPDOWN, ORDER_STATUS_DROPDOWN };
...
export const LEAD_SOURCE = [
	...
	'Partner',
	'Public Relations',
	'Sales Email Alias','Seminar Partner','Internal Seminar','Trade Show','Web Download',
	'Web Research',
	'Chat',
	'X (Twitter)',
	'Facebook',
...
export const LEAD_STATUS = ['-None-', 'Attempted to Contact', 'Contact in Future', 'Contacted', 'Junk Lead', 'Lost Lead', 'Not Contacted', 'Pre-Qualified', 'Not Qualified'];
...
export const INDUSTRY = [
	...
	'Government/Military',
	'Large Enterprise','Management ISV','MSP (Management Service Provider)',
	'Network Equipment Enterprise',
	'Non-management ISV','Optical Networking','Service Provider',
...
export const RATING=['-None-','Acquired','Active','Market Failed','Project Cancelled','Shut Down']
